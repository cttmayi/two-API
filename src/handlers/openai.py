    ...
    *,
    ...
    async def stream_converted():
        ...
        if status_code != 200 and not output_content:
            ...
            if error_text:
                logger.error("responses_to_chat_backend_error", status=status_code, error=error_text)
    ...
    try:
        if entry.responses_to_chat:
            ...
            if resp.status_code == 200:
                ...
                logger.error("responses_to_chat_backend_error", status=resp.status_code, error=error_body)
